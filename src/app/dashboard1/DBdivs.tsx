...
import ovimg from "../../../public/images/Vectoroverview-selected.png";
...
export default function DBdivs() {
  ...
  return (
    <div>
      ...
      <div className="logout-div p-14 flex mt-24" onClick={handleLogout}>
